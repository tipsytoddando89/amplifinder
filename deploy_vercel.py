...
FILES = [
    ...
    # Renamed datasheets used by the Datasheets dropdown
    ("assests/AS50SYS_Datasheet.pdf", "assests/AS50SYS_Datasheet.pdf", "base64"),
    ("assests/Ambisonic-12HDR-AW_Datasheet.pdf", "assests/Ambisonic-12HDR-AW_Datasheet.pdf", "base64"),
    ("assests/Ambisonic-ALSB-Hex-Bollard_Datasheet.pdf", "assests/Ambisonic-ALSB-Hex-Bollard_Datasheet.pdf", "base64"),
    ("assests/Ambisonic-ASBR-Soundbar_Datasheet.pdf", "assests/Ambisonic-ASBR-Soundbar_Datasheet.pdf", "base64"),
    ("assests/Ambisonic-ASM63-ASM63SUB_Datasheet.pdf", "assests/Ambisonic-ASM63-ASM63SUB_Datasheet.pdf", "base64"),
    ("assests/Ambisonic-ASM63-Hex-SurfaceMount_Datasheet.pdf", "assests/Ambisonic-ASM63-Hex-SurfaceMount_Datasheet.pdf", "base64"),
    ("assests/Ambisonic-Marquee-AM650OWA_Datasheet.pdf", "assests/Ambisonic-Marquee-AM650OWA_Datasheet.pdf", "base64"),
    ("assests/Blends-CSUB10-Subwoofer_Datasheet.pdf", "assests/Blends-CSUB10-Subwoofer_Datasheet.pdf", "base64"),
    ("assests/Blends-Speakers_Datasheet.pdf", "assests/Blends-Speakers_Datasheet.pdf", "base64"),
    ("assests/Burial-10BP-Subwoofer_Datasheet.pdf", "assests/Burial-10BP-Subwoofer_Datasheet.pdf", "base64"),
    ("assests/Burial-12BP-Subwoofer_Datasheet.pdf", "assests/Burial-12BP-Subwoofer_Datasheet.pdf", "base64"),
    ("assests/Burial-S11BP-Subwoofer_Datasheet.pdf", "assests/Burial-S11BP-Subwoofer_Datasheet.pdf", "base64"),
    ("assests/Composer-C60S_Datasheet.pdf", "assests/Composer-C60S_Datasheet.pdf", "base64"),
    ("assests/Composer-CIW60-InWall_Datasheet.pdf", "assests/Composer-CIW60-InWall_Datasheet.pdf", "base64"),
    ("assests/Composer-CIWS_Datasheet.pdf", "assests/Composer-CIWS_Datasheet.pdf", "base64"),
    ("assests/Composer-CSUBIW10N-InWall-Subwoofer_Datasheet.pdf", "assests/Composer-CSUBIW10N-InWall-Subwoofer_Datasheet.pdf", "base64"),
    ("assests/Composer-LCR60-Series_Datasheet.pdf", "assests/Composer-LCR60-Series_Datasheet.pdf", "base64"),
    ("assests/Composer-LCR60_Datasheet.pdf", "assests/Composer-LCR60_Datasheet.pdf", "base64"),
    ("assests/Composer-Theater-THTR60_Datasheet.pdf", "assests/Composer-Theater-THTR60_Datasheet.pdf", "base64"),
    ("assests/Composer-Theater_Datasheet.pdf", "assests/Composer-Theater_Datasheet.pdf", "base64"),
    ("assests/DSP60-8-Amplifier_Datasheet.pdf", "assests/DSP60-8-Amplifier_Datasheet.pdf", "base64"),
    ("assests/Director-10Inch_Datasheet.pdf", "assests/Director-10Inch_Datasheet.pdf", "base64"),
    ("assests/Director-3Inch_Datasheet.pdf", "assests/Director-3Inch_Datasheet.pdf", "base64"),
    ("assests/Director-5Inch_Datasheet.pdf", "assests/Director-5Inch_Datasheet.pdf", "base64"),
    ("assests/Director-6Inch_Datasheet.pdf", "assests/Director-6Inch_Datasheet.pdf", "base64"),
    ("assests/Director-8Inch_Datasheet.pdf", "assests/Director-8Inch_Datasheet.pdf", "base64"),
    ("assests/Explorer-CSUBIW10R-EX-InWall-Subwoofer_Datasheet.pdf", "assests/Explorer-CSUBIW10R-EX-InWall-Subwoofer_Datasheet.pdf", "base64"),
    ("assests/Explorer-InCeiling_Datasheet.pdf", "assests/Explorer-InCeiling_Datasheet.pdf", "base64"),
    ("assests/Hardscape-6510P-Subwoofer_Datasheet.pdf", "assests/Hardscape-6510P-Subwoofer_Datasheet.pdf", "base64"),
    ("assests/Immersive-6.5HD-AW_Datasheet.pdf", "assests/Immersive-6.5HD-AW_Datasheet.pdf", "base64"),
    ("assests/Landscape-6.5HD-AW-DoubleStack_Datasheet.pdf", "assests/Landscape-6.5HD-AW-DoubleStack_Datasheet.pdf", "base64"),
    ("assests/Landscape-6.5HD-AW-SingleStack_Datasheet.pdf", "assests/Landscape-6.5HD-AW-SingleStack_Datasheet.pdf", "base64"),
    ("assests/Landscape-70V-Bollards_Datasheet.pdf", "assests/Landscape-70V-Bollards_Datasheet.pdf", "base64"),
    ("assests/Landscape-70V-Sats-Subs_Datasheet.pdf", "assests/Landscape-70V-Sats-Subs_Datasheet.pdf", "base64"),
    ("assests/Landscape-LSH-Hex-Satellite_Datasheet.pdf", "assests/Landscape-LSH-Hex-Satellite_Datasheet.pdf", "base64"),
    ("assests/Landscape-LSR_Datasheet.pdf", "assests/Landscape-LSR_Datasheet.pdf", "base64"),
    ("assests/MOS36K_Datasheet.pdf", "assests/MOS36K_Datasheet.pdf", "base64"),
    ("assests/MOS36SUB_Datasheet.pdf", "assests/MOS36SUB_Datasheet.pdf", "base64"),
    ("assests/OriginPRO-1RU-Amps_Datasheet.pdf", "assests/OriginPRO-1RU-Amps_Datasheet.pdf", "base64"),
    ("assests/OriginPRO-2RU-8Ch_Datasheet-2025-02.pdf", "assests/OriginPRO-2RU-8Ch_Datasheet-2025-02.pdf", "base64"),
    ("assests/OriginPRO-2RU-8Ch_Datasheet.pdf", "assests/OriginPRO-2RU-8Ch_Datasheet.pdf", "base64"),
    ("assests/OriginPRO-PC_Datasheet.pdf", "assests/OriginPRO-PC_Datasheet.pdf", "base64"),
    ("assests/OriginPRO-PPCT_Datasheet.pdf", "assests/OriginPRO-PPCT_Datasheet.pdf", "base64"),
    ("assests/OriginPRO-PP_Datasheet.pdf", "assests/OriginPRO-PP_Datasheet.pdf", "base64"),
    ("assests/OriginPRO-PSUB10X2_Datasheet.pdf", "assests/OriginPRO-PSUB10X2_Datasheet.pdf", "base64"),
    ("assests/OriginPRO-PS_Datasheet.pdf", "assests/OriginPRO-PS_Datasheet.pdf", "base64"),
    ("assests/Performance-Powered-Subwoofers_Datasheet.pdf", "assests/Performance-Powered-Subwoofers_Datasheet.pdf", "base64"),
    ("assests/SBR4-Soundbar_Datasheet.pdf", "assests/SBR4-Soundbar_Datasheet.pdf", "base64"),
    ("assests/SUBA-500-150-Amplifier_Datasheet.pdf", "assests/SUBA-500-150-Amplifier_Datasheet.pdf", "base64"),
    ("assests/Transformers_Datasheet.pdf", "assests/Transformers_Datasheet.pdf", "base64"),
    ("assests/other docs/2025_Pricebook.pdf", "assests/other docs/2025_Pricebook.pdf", "base64"),
    ("assests/other docs/Ambisonic-10HDR_StartGuide.pdf", "assests/other docs/Ambisonic-10HDR_StartGuide.pdf", "base64"),
    ("assests/other docs/Ambisonic-ASBR-Soundbar_Quickstart.pdf", "assests/other docs/Ambisonic-ASBR-Soundbar_Quickstart.pdf", "base64"),
    ("assests/other docs/Ambisonic-ASM_Manual.pdf", "assests/other docs/Ambisonic-ASM_Manual.pdf", "base64"),
    ("assests/other docs/Composer-CSUB10N-Subwoofer_Manual.pdf", "assests/other docs/Composer-CSUB10N-Subwoofer_Manual.pdf", "base64"),
    ("assests/other docs/DSP2-200-Amplifier_Manual.pdf", "assests/other docs/DSP2-200-Amplifier_Manual.pdf", "base64"),
    ("assests/other docs/DSP3-150-Amplifier_Manual.pdf", "assests/other docs/DSP3-150-Amplifier_Manual.pdf", "base64"),
    ("assests/other docs/Explorer-CSUB10REX-InWall-Subwoofer_Manual.pdf", "assests/other docs/Explorer-CSUB10REX-InWall-Subwoofer_Manual.pdf", "base64"),
    ("assests/other docs/Landscape-LSH40-60-80_Manual.pdf", "assests/other docs/Landscape-LSH40-60-80_Manual.pdf", "base64"),
    ("assests/other docs/SBR4-Soundbar_Quickstart.pdf", "assests/other docs/SBR4-Soundbar_Quickstart.pdf", "base64"),
    ("assests/other docs/SUBS10-Subwoofer_StartGuide.pdf", "assests/other docs/SUBS10-Subwoofer_StartGuide.pdf", "base64"),
    ("assests/other docs/Warranty-Returns-Process.pdf", "assests/other docs/Warranty-Returns-Process.pdf", "base64"),
]
